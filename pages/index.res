...
let default = () =>
  <Layout>
    <Next.Head>
      <title> {"Life Stewardship, Financial Planning & Coaching"->string} </title>
    </Next.Head>
    <div
    ...
    <div className="lg:grid lg:grid-cols-2">
      ...
      <div className="max-w-xl mx-auto">
        <Paragraph>
          ...
          as its managing partner."->string}
        </Paragraph>
        <Paragraph>
          ...
          treasurer, president, vice chairman and board chairman."->string}
        </Paragraph>
        <Paragraph>
          {"My public accounting practice also included working with individuals
          regarding their financial planning and income taxes."->string}
        </Paragraph>
      </div>
    </div>
    ...
    <div className="grid gap-5 grid-cols-1 lg:grid-cols-2">
      <Affiliation> {"American Institute of Certified Public Accountants"->string} </Affiliation>
      <Affiliation> {"AICPA Not-for-Profit Section"->string} </Affiliation>
      <Affiliation> {"AICPA Personal Financial Planning Section"->string} </Affiliation>
      <Affiliation> {"Vice-Chairman Baptist Hospital Board of Directors"->string} </Affiliation>
    </div>
    <ContactCTA />
  </Layout>
