...
let default = () =>
  <Layout>
    <Next.Head> <title> {"Nonprofit - Life Stewardship"->string} </title> </Next.Head>
    <h1 className={Heading.Styles.primary ++ " mb-5"}> {"Nonprofit"->string} </h1>
    <div
    ...
    <Paragraph>
      ...
      {"Serving others or making things better is
          ...
          they assume a stewardship responsibility for them."->string}
    </Paragraph>
    <Paragraph>
      {"Board members and management have the primary responsibility for
          ...
          clients/constituents, donors, the public, and government authorities."->string}
    </Paragraph>
    <Paragraph>
      {"For the board of directors and management to fulfill their fiduciary
          ...
          applicable laws and regulations."->string}
    </Paragraph>
    <Paragraph>
    ...
    <Paragraph>
      {"If you want more information or need help fulfilling your fiduciary
          responsibilities, let’s talk. I can assist you with:"->string}
    </Paragraph>
    <UnorderedList>
