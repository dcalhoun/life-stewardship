...
let default = () =>
  <Layout>
    <Next.Head> <title> {"Individuals - Life Stewardship"->string} </title> </Next.Head>
    <h1 className={Heading.Styles.primary ++ " mb-5"}> {"Individuals"->string} </h1>
    <div
    ...
    <Paragraph>
      ...
      {" Beginning is often the hardest step. We do not know how
          ...
          may not provide us the best solutions"->string}
    </Paragraph>
    <Paragraph>
      {"Being a good steward of our personal finances is something we all
          ...
          we can accomplish the goals which are important to us."->string}
    </Paragraph>
    <Paragraph>
    ...
    <Paragraph>
      {(j`${"If you are ready to get begin, let"}’${"s talk. I can assist
          you with:"}`)
        ->string}
    </Paragraph>
    <UnorderedList>
