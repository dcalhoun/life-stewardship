...
let default = () => {
  <>
    <Next.Head>
      <title>
        "Life Stewardship, Financial Planning &amp; Coaching"->React.string
      </title>
    </Next.Head>
    <Navigation />
    <main id="content">
      ...
      <p> "Professional and Community Affiliation"->React.string </p>
      <ul>
        <li>
          "American Institute of Certified Public Accountants"->React.string
        </li>
        <li> "AICPA Not-for-Profit Section"->React.string </li>
        <li> "AICPA Personal Financial Planning Section"->React.string </li>
        <li>
